...
import type { Product, ProductSummary, ProductsQueryParams } from '../types/product.types';

export const productService = {
  /** Get paginated product list with optional filters */
  async getAll(params?: ProductsQueryParams): Promise<PaginatedResponse<ProductSummary>> {
