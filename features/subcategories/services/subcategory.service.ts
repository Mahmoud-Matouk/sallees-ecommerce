...
import type { Subcategory, SubcategoriesQueryParams } from '../types/subcategory.types';

export const subcategoryService = {
  async getAll(params?: SubcategoriesQueryParams): Promise<PaginatedResponse<Subcategory>> {
